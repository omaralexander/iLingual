//
//  selectingALanguage.swift
//  Ai-Lingual
//
//  Created by Omar Abbas on 1/17/18.
...
class selectingALanguage:UIViewController,UICollectionViewDelegate,UICollectionViewDataSource, GADBannerViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        bannerView.adUnitID = "ca-app-pub-5917202857375028/3936246012"
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        self.translatingFromLanguage = value.speechCode
        self.googleCodeTranslatingFromLanguage = value.googleCode
        performSegue(withIdentifier: "translatingToSegue", sender: self)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "translatingToSegue"{
            let viewController = segue.destination as! translatingToVC
            ...
            viewController.urlOfVideo = self.urlOfVideo
